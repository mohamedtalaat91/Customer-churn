...
zip_file_path = r"E:\Epsilon AI\final_project\Deployment\source\churn.csv"
data = pd.read_csv(zip_file_path)

st.markdown('''<center> <h1> Customer Churn Data Discription </h1> </center>''',unsafe_allow_html=True)
disc = pd.read_csv(r"E:\Epsilon AI\final_project\Deployment\source\description.csv" ,index_col='column')
st.write(disc)
